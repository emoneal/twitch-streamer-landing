  ...
  return (
    ...
    <section id="bio" className="py-8 bg-gray-900 my-4 rounded-lg">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-gray-600 mb-4">About FlexieUwU</h2>
        <p className="text-gray-300">
        Hello, digital world! I&apos;m FlexieUwU, your virtual companion in the vibrant realm of gaming. My journey began with the simple joys of an NES, evolving into an immersive experience that spans continents, from Japan to the dynamic universe of online streaming.
        <br /><br />
        ...
        <br /><br />
        Off-camera, my world orbits around my lovebird Melon, reflecting a life filled with simplicity and affection. These moments away from the screen fuel my creativity and passion for gaming.
        <br /><br />
